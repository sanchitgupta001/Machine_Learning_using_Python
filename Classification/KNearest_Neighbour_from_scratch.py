...
def k_nearest_neighbors(data, predict, k=3):
    ...
    confidence = Counter(votes).most_common(1)[0][1]/k # In statistics, a confidence interval (CI) is a type of interval estimate of a population parameter
    # In order to get more than 1 most common pass n required as an argument to most_common() function.
    return vote_result, confidence

accuracies = []    
for l in range(10): # Number of times we want to compute accuracies for different datasets
